...
class Program
{
    static void Main(string[] args)
    {
        ...
        = "Server=localhost,1433;Database=balta;User ID=sa;Password=D0ck3er!5814!;Trusted_Connection=False; TrustServerCertificate=True";
    ...
    {
        var deleteQuery = "DELETE [Category] FROM [Category] WHERE [Title]=@title";
    ...
    static void ExecuteProcedure(SqlConnection connection)
    {
        ...
        var pars = new { StudentId = "5a38bf40-9d6c-449a-9968-f362ca54df46" };
    ...
    {
        var category = new Category();
        category.Title = "Azure Server";
        category.Url = "azure";
        category.Summary = "Azure Cloud";
        category.Order = 9;
        category.Description = "Categoria destinada a Azure";
        category.Featured = false;
    ...
    static void OneToOne(SqlConnection connection)
    {
        ...
        {
            Console.WriteLine($"{item.Title} - Curse: {item.Course.Title}");
        }
    }
    ...
    static void Transaction(SqlConnection connection)
    {
        ...
        category.Url = "react";
        category.Summary = "React Native";
        category.Order = 10;
        category.Description = "Categoria destinada a React";
        category.Featured = false;
